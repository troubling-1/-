...
function EscortDashboardContent() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10">
      ...
      <p className="mt-2 text-sm text-muted-foreground">管理资料、订单、收入统计和提现申请。</p>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-primary">{formatMoney(totalIncome)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
